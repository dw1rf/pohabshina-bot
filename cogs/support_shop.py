...
SHOP_SERVICES: tuple[ShopService, ...] = (
    ...
    ShopService("mc_op", "Права /op", "2 499 ₽", "Полный доступ к Minecraft-серверу «пахабщины»: креатив/выживание, телепортация, безлимитные показы. Выдаётся только после проверки и согласования с администрацией."),
